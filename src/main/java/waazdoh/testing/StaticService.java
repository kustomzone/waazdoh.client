...
public final class StaticService implements ServiceClient {
	...
	public ObjectsService getObjects() {
		if (objects == null) {
			objects = new ObjectsServiceImplementation();
		}
	...
	public UsersService getUsers() {
		if (users == null) {
			users = new UsersServiceImplementation();
		}
		return users;
	}
	...
	public StorageAreaService getStorageArea() {
		if (storagearea == null) {
			storagearea = new StorageAreaServiceImplementation();
		}
		return storagearea;
	}
	...
	private final class StorageAreaServiceImplementation implements
			StorageAreaService {
		@Override
	...
	private final class UsersServiceImplementation implements UsersService {
		@Override
